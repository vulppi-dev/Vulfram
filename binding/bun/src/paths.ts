...
const VULFRAM_CORE_LIBS: Record<string, any> = {
  darwin: {
    arm64: 'assets/arm64/darwin/libvulfram-core.dylib',
    x64: 'assets/x64/darwin/libvulfram-core.dylib',
  },
  linux: {
    arm64: 'assets/arm64/linux/libvulfram-core.so',
    x64: 'assets/x64/linux/libvulfram-core.so',
  },
  win32: {
